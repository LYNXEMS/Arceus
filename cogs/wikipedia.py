...
class Wikipedia:
    ...
    async def wikipedia(self, ctx, *text):
        ...
        if text == ():
            ...
            wikiLang = 'pl'# Define the Wikipedia language / Most of these are supported » https://nl.wikipedia.org/wiki/ISO_3166-1
            ws = None
            ...
            try:
                ...
                await self.bot.say( 'Przepraszam {}, nie znalazlam nic takiego'.format(user))
